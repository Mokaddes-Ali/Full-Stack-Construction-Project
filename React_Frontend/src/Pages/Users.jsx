...
const Users = () => {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            const response = await axios.post('http://your-laravel-api-url/api/register', {
                name,
                email,
                password,
            ...
            if (error.response) {
                setMessage(error.response.data.errors ? error.response.data.errors : "Something went wrong.");
            } else {
