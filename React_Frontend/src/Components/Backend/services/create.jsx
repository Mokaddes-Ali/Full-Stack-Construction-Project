      ...
      <div className="flex min-h-screen bg-gray-700">
        <div className="w-full bg-white p-8 rounded-md shadow-lg">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <input onChange={handleFile} type="file" className="mt-2 w-full p-2 border rounded" />
            </div>
            {imagePreview && <div><img src={imagePreview} alt="Uploaded Preview" className="w-20 h-20 object-cover rounded-lg shadow-md" /></div>}
          </div>
              </div>
            </div>
            <div>
