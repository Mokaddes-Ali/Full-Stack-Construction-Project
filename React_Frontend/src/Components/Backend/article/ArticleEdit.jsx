...
//       setArticle((prev) => ({
//         ...prev,
//         image: imageId,  // নতুন ইমেজ আপডেট করুন
//       }));
//     }
//   }, [imageId]);
...
//     const res = await fetch(apiUrl + "temp-image/" + params.id, {
//       method: "PUT",
//       headers: {
//         Accept: "application/json",
//         Authorization: `Bearer ${token()}`,
...
//       toast.error(result.errors.image[0]);
//     } else {
//       setImageId(result.data.name);  // ইমেজ আইডির পরিবর্তে নাম সেট করুন
//       setArticle((prev) => ({
//         ...prev,
//         image: result.data.name,  // নতুন ইমেজ আপডেট করুন
//       }));
//       toast.success(result.message);
//     }
//   };
...
//             {article.image && (
//              <img 
//              src={`${fileUrl}uploads/temp/${article.image}`} 
//              alt="Article Preview"
//              className="mt-2 w-32 h-32 object-cover rounded-lg border dark:border-gray-700" 
//            />           
//             )}
