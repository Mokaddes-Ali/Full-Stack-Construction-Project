    ...
    return (
        <footer className="pt-10 bg-gray-800">
            ...
            <div className="px-4 md:px-8">
                ...
                <div className="justify-between flex-1 mt-16 space-y-6 sm:flex md:space-y-0">
                    {
                        footerNavs.map((item, idx) => (
                            <ul
                                ...
                                key={idx}
                            >
                                <h4 className="font-semibold text-gray-200 sm:pb-2">
                                    {item.label}
                                </h4>
                                {
                ...
                <div className="items-center justify-between py-10 mt-10 border-t border-gray-700 sm:flex">
