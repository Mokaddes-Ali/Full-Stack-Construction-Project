...
const Testimonial = () => {
  ...
  return (
    <div className="relative overflow-hidden py-16 bg-blue-gray-300">
      {/* Background Scrolling Text */}
      <motion.div
        className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center overflow-hidden space-y-10"
