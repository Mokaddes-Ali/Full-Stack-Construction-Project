...
//             {hoveredIndex === idx && (
//               <motion.span
//                 className="absolute inset-0 h-full w-full bg-blue-gray-200 dark:bg-slate-800/[0.8] block  rounded-3xl"
...
export const Card = ({ className, children, image }) => {
  return (
    <div
      ...
      <img src={image} alt="Card image" className="h-48 w-full object-cover rounded-xl" />
      <div className="relative z-50">
        <div className="p-4">{children}</div>
      </div>
    </div>
